...
public interface IBaseService<T> {
	...
	/**
	 * 根据参数中不为空的属性查询列表,传参值以逗号分隔如1,2,3
	 * 
	 * @param params
	 * @return
	 */
	...
	/**
	 * 根据参数查询列表，key对应dto中的属性 会转成 List<T> queryByParam(Map
	 * <String,Object> params);
	 * 
	 * @param id
	 * @return
	 */
	List<T> queryByParamArray(Object... params);
	...
	/**
	 * 根据对象中不为空的属性查询列表,已经实现,可以用
	 * 
	 * @param id
	 * @return
	 */
	RemotePage<T> queryPageByObject(T obj, PageInfo info);
	 ...
	 * @return
	 */
	RemotePage<T> queryPageByParamNotEmpty(Map<String, Object> params, PageInfo info);
	 ...
	 * @return
	 */
	RemotePage<T> queryPageByParam(Map<String, Object> params, PageInfo info);
}
