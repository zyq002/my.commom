...
public class JsonUtil {
    ...
    private static DeserializationProblemHandler dph = new MyDeserializationProblemHandler();
    /**
    ...
    public static <T> T json2java(String json, Class<T> valueType) {
        T obj = null;
        try {
        	mapper.getDeserializationConfig().addHandler(dph);
    ...
    static class MyDeserializationProblemHandler extends DeserializationProblemHandler {
    	@Override
